            ...
            <div class="login-wrap">
                <div class="login-content">
                    <div class="login-logo">
                        <a href="#">
                            <img src="{{ asset('assets/images/icon/logo.png') }}" alt="ministere de la justice">
                        </a>
                    </div>
                    <div class="login-form">
                        <form method="POST" action="{{ route('password.email') }}">
                            ...
                            <div>
                                ...
                                <x-text-input id="email" class="au-input au-input--full" type="email" name="email" :value="old('email')" required autofocus />
